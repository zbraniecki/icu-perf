...
impl NumberFormatter {
    ...
    #[cfg(feature = "icu4x-static")]
    pub fn new_static(provider: &BlobDataProvider, langid: &icu_locale::LanguageIdentifier, options: FixedDecimalFormatterOptions) -> Self {
    ...
    pub fn new_baked(
        ...
        let ptr = icu_decimal::FixedDecimalFormatter::try_new(
            &langid.into(),
            options,
        )
        .unwrap();
    ...
    pub fn format(&self, input: f64) -> String {
        ...
        let decimal = FixedDecimal::try_from_f64(input, DoublePrecision::RoundTrip)
